...
const english: Translations = {
  ...
  demoMode: "Demo Mode",
  exitDemo: "Exit Demo",
  developerName: "Taha Shahud",
  developerTitle: "Student Developer · Creative Minded · Exploring AI",
  developerDescription: "Building practical digital tools that support human wellbeing and accessible mental health support. Many ideas, actually building them.",
  ...
  therapistComingSoonTitle: "Support Chat — Coming Soon",
  therapistComingSoonDesc: "Support Chat is currently under development. We are working on making TalkEasy safe, reliable and meaningful before its official release.",
  therapistNextVersion: "Support Chat will be available in the next TalkEasy version.",
  ...
  meetTheDevelopers: "Meet the Developer",
  ...
  needSomeoneToTalk: "Need someone to talk to?",
  ...
  moodTrackerSubtitle: "Track your emotional state daily",
  ...
  habitTrackerSubtitle: "Build and track daily habits",
  sleepHabit: "Sleep 8 hours",
  waterHabit: "Drink 8 glasses of water",
  exerciseHabit: "Exercise for 30 minutes",
  meditationHabit: "Meditate for 10 minutes",
  journalHabit: "Write in journal",
  addHabit: "Add Habit",
  completed: "Completed",
  journalTitle: "Journal",
  journalSubtitle: "Reflect on your thoughts and experiences",
  ...
  chatSubtitle: "TalkEasy AI · Powered locally by Ollama",
  typeMessagePlaceholder: "Type your message...",
  send: "Send",
  teleManasNotice: "This feature is currently under development and will be available in the next TalkEasy version.",
  findHelpTitle: "Find Help",
  findHelpSubtitle: "Professional and crisis-support resources",
  ...
  adult: "Adult (36-55)",
  senior: "Senior (55+)",
  anyThoughtsLabel: "Any thoughts?",
  thoughtsPlaceholder: "Write your thoughts here...",
  todaysGoals: "Today's Goals",
  noHabitsToday: "No habits tracked today",
  customHabitPlaceholder: "Add custom habit...",
  suggestions: "Suggestions",
  trackingAllHabits: "Tracking all habits",
  ...
  startWritingFirstEntry: "Start writing your first entry",
  ...
  journalTypeFree: "Free",
  statisticsTitle: "Statistics",
  statisticsSubtitle: "Track your wellness patterns",
  moodTrendChart: "Mood Trend",
  habitCompletionChart: "Habit Completion",
  completionRate: "Completion Rate",
  moodLabel: "Mood",
  startSupportiveConversation: "Start Supportive Conversation",
  supportChatDescription: "TalkEasy AI provides supportive conversation to help you reflect and organize your thoughts.",
